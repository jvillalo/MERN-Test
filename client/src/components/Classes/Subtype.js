...
class Subtype {
  constructor(name, entity, inheritance, role) {
    this.name = name;
    this.entity = entity;
    ...
    this.secondaryIdInheritanceParticipant = uuid;
  }
  ...
  connect(graph, level) {
    ...
    try {
      ...
      var style = "";
      if (this.role == "supertype") {
        style = "supertype;labelPosition=left;align=left";
      } else {
        style = "subtype;labelPosition=left;align=left";
      }
